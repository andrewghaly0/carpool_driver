...
class UniRequestsPageDriver extends StatefulWidget {
  const UniRequestsPageDriver({Key? key}) : super(key: key);

  @override
  _UniRequestsPageDriverState createState() => _UniRequestsPageDriverState();
}

class _UniRequestsPageDriverState extends State<UniRequestsPageDriver> with TickerProviderStateMixin {
  late UniRequestsPageDriverModel _model;
...
class UniRequestsPageDriverModel extends ChangeNotifier {
...
UniRequestsPageDriverModel createModel() => UniRequestsPageDriverModel();