...
class RidePageHomeDriver extends StatefulWidget {
  final String driverName;
  final String carID;
  final String phoneNumber;

  const RidePageHomeDriver({
    Key? key,
  ...
  @override
  _RidePageHomeDriverState createState() => _RidePageHomeDriverState();
}

class _RidePageHomeDriverState extends State<RidePageHomeDriver> {
  late RidePageHomeDriverModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RidePageHomeDriverModel());
...
class RidePageHomeDriverModel extends FlutterFlowModel<RidePageHomeDriver> {
  /// State fields for stateful widgets in this page.
  String? driverName;
  String? carID;
  String? phoneNumber;
  DateTimeRange? calendarSelectedDay;
  static const String time = '5:30 PM';
